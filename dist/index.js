...
var c=require('@stdlib/assert-is-plain-object/dist'),f=require('@stdlib/assert-is-ndarray-like/dist'),m=require('@stdlib/assert-is-function/dist'),o=require('@stdlib/assert-has-own-property/dist'),l=require('@stdlib/ndarray-empty-like/dist'),d=require('@stdlib/ndarray-base-map/dist'),v=require('@stdlib/error-tools-fmtprodmsg/dist');function q(r,e,u,y){var n,a,t,s,i;if(!f(r))throw new TypeError(v('2535t',r));if(arguments.length<3?a=e:arguments.length===3?m(e)?(a=e,s=u):(n=!0,t=e,a=u):(n=!0,t=e,a=u,s=y),!m(a))throw new TypeError(v('2532b',a));if(n){if(!c(t))throw new TypeError(v('2532V',t));o(t,"dtype")?i=l(r,{dtype:t.dtype}):i=l(r)}else i=l(r);return d([r,i],a,s),i}g.exports=q
